    ...
    if is_ai_toolkit:
        ...
        if model_type == "sdxl":
            if model_name in REALISTIC_MODELS:
                print(f"Categorizing as REALISTIC for {model_name} (Striker Strategy)", flush=True)
                ...
                print(f"Categorizing as ANIME for {model_name} (Striker Strategy)", flush=True)
                ...
                print(f"Categorizing as GENERAL for {model_name} (Striker Strategy)", flush=True)
